...
//    $("#subRed").animate({opacity:0},{duration:200});
//    $("#subRed").animate({opacity:1},{duration:200});
//
//    $("#subGreen").animate({opacity:0},{duration:600});
//    $("#subGreen").animate({opacity:1},{duration:200});
//
//    $("#subBlue").animate({opacity:0},{duration:1200});
//    $("#subBlue").animate({opacity:1},{duration:200});
//
//    $("#subYellow").animate({opacity:0},{duration:1400});
//    $("#subYellow").animate({opacity:1},{duration:200});
//
//})
//});
